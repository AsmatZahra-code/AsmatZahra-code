...
✨ **7+** open-source contributions (Gerrit)  
🏆 **Class Rank (GR)** - Top academic performer  
👥 **Leadership** - Led multiple university projects  
📈 **Continuous Learner** - Completed deep dives in Linux, Docker, CI/CD, and moving through cloud technologies
